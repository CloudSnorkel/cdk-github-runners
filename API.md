...
It is not unique to this instance and its only dimension is `Status`. The status can be one of "Succeeded", "SucceededWithIssues", "Failed", "Canceled", "Skipped", or "Abandoned".
